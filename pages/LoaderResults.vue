<template>
  <div class="loader text-center d-flex flex-column align-items-center justify-content-around">
    <div class="title mt-4">
      <h1 v-if="action === 'waiting'">Leyenedo tus tweets...</h1>
      <h1 v-if="action === 'reading'">Analizando tus tweets...</h1>
      <h1 v-if="action === 'ready'">¡Listo!</h1>
    </div>
    ...
    <peep v-if="action === 'waiting'" action="waiting" :activePeep="activePeep" />
    <peep v-if="action === 'reading'" action="reading" :activePeep="activePeep" />
